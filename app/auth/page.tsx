              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ position: 'relative' }}>
                  <select value={country} onChange={(e) => setCountry(e.target.value)}
                    style={{ width: '100%', padding: '12px 16px', borderRadius: '8px', border: '1px solid ' + (country ? '#2E9E5E' : '#1A7A4A'), backgroundColor: '#0D1F0F', color: country ? 'white' : '#6B7280', fontSize: '14px', outline: 'none', boxSizing: 'border-box', appearance: 'none', cursor: 'pointer' }}>
