...
export const metadata: Metadata = {
  title: 'Nigeria Football Predictions | EPL & UCL | Flipseer',
  description: 'Nigerian football fans predict EPL, UCL, Liga 1 and Ghana PL matches on Flipseer. Represent Nigeria in the global Nation Battle. Free forever.',
...
export default function NigeriaPage() {
  const steps = [
    ...
    { num: '3', title: 'Earn REP', desc: 'Correct predictions earn REP points for you and for Nigeria in the Nation Battle.' },
  ]
  const competitions = [
    ...
    <main style={{ backgroundColor: '#0D1F0F', minHeight: '100vh', fontFamily: 'Arial, sans-serif', color: 'white', paddingBottom: '60px' }}>
      <div style={{ background: 'linear-gradient(180deg, #0D2B14 0%, #0D1F0F 100%)', padding: '48px 20px 32px', textAlign: 'center', borderBottom: '1px solid #1A3A1A' }}>
        ...
        <p style={{ color: '#9CA3AF', fontSize: '15px', maxWidth: '480px', margin: '0 auto 24px', lineHeight: 1.7 }}>
          Nigeria has one of the largest football fan bases in the world. From the Super Eagles to European football, Nigerian forecasters compete on Flipseer across EPL, UCL, Liga 1 and Ghana Premier League. Every correct prediction earns REP points for Nigeria in the global Nation Battle.
        </p>
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/predict" style={{ backgroundColor: '#008751', color: 'white', padding: '12px 28px', borderRadius: '10px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
            ⚽ Predict EPL matches for Nigeria →
          </a>
