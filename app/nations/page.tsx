...
export default function NationsPage() {
  ...
  const shareText = userNation
    ? '\uD83C\uDF0D ' + userNation.name + ' is ranked #' + userRank + ' on Flipseer World Cup 2026 leaderboard with ' + userNation.points + ' pts! Join the battle -> flipseer.com/nations #PremierLeague #EPL2027 #Flipseer'
    : '\uD83C\uDF0D The World Cup 2026 Nation Battle is live on Flipseer! Which country leads? flipseer.com/nations #PremierLeague #EPL2027';
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto', padding: '24px 20px 0' }}>
        ...
        {!loading && nations.length > 0 && (
          <div style={{ textAlign: 'center', marginTop: '24px', backgroundColor: '#0D2B14', border: '1px solid #1A7A4A', borderRadius: '14px', padding: '24px' }}>
            ...
            <p style={{ color: '#6B7280', fontSize: '13px', marginBottom: '16px' }}>Predict EPL matches to earn points for your country</p>
