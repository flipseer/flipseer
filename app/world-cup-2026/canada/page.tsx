    ...
    <main style={{ backgroundColor: '#0D1F0F', minHeight: '100vh', fontFamily: 'Arial, sans-serif', color: 'white' }}>
      <section style={{ background: 'linear-gradient(180deg, #0D2B14 0%, #0D1F0F 100%)', padding: '80px 20px 60px', textAlign: 'center', borderBottom: '1px solid #1A3A1A' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'inline-block', border: '1px solid #EF4444', borderRadius: '20px', padding: '6px 20px', marginBottom: '12px' }}>
            <span style={{ fontSize: '13px', color: '#EF4444', fontWeight: 'bold', letterSpacing: '2px' }}>WORLD CUP 2026 &middot; CANADA &middot; HOST NATION</span>
          </div>
          <div style={{ marginBottom: '20px' }}>
            <span style={{ fontSize: '13px', color: '#F59E0B', fontWeight: 'bold', backgroundColor: 'rgba(245,158,11,0.1)', padding: '4px 12px', borderRadius: '999px', border: '1px solid #F59E0B' }}>
              BMO Field Toronto &middot; BC Place Vancouver
            </span>
          </div>
          <h1 style={{ fontFamily: 'Georgia, serif', fontSize: '44px', lineHeight: '1.2', marginBottom: '16px' }}>Canada. Host Nation. History in the Making.</h1>
          <p style={{ fontSize: '18px', color: '#9CA3AF', lineHeight: '1.7', maxWidth: '600px', margin: '0 auto 32px' }}>
            Co-host nation. Les Rouges on home soil for the first time.<br />
            <strong style={{ color: '#D1FAE5' }}>Build your permanent football reputation on Flipseer.</strong>
          </p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="/predict" style={{ backgroundColor: '#EF4444', color: 'white', padding: '16px 36px', borderRadius: '10px', textDecoration: 'none', fontSize: '16px', fontWeight: 'bold' }}>Predict for Canada &#x2192;</a>
      ...
      <section style={{ padding: '64px 20px', borderBottom: '1px solid #1A3A1A' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', marginBottom: '24px' }}>Why Canada fans belong on Flipseer.</h2>
          <p style={{ color: '#9CA3AF', fontSize: '16px', lineHeight: '1.8', marginBottom: '16px' }}>
            Canada qualified for their first World Cup in 36 years in 2022 and made history. Now as a co-host nation in 2026, Les Rouges play in front of their home fans for the first time ever at a World Cup. This is Canada's football moment.
          </p>
          <p style={{ color: '#6B7280', fontSize: '15px', lineHeight: '1.8' }}>
            Canadian football is growing fast. From Alphonso Davies to Jonathan David, a golden generation has arrived. Canadian fans are passionate, multicultural, and ready to back their team on the biggest stage of all.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '64px 20px', backgroundColor: '#050E05', borderBottom: '1px solid #1A3A1A' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', textAlign: 'center', marginBottom: '32px' }}>Teams Canada fans love.</h2>
      ...
      <section style={{ padding: '64px 20px', borderBottom: '1px solid #1A3A1A' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', textAlign: 'center', marginBottom: '40px' }}>Represent Canada. Earn your legacy.</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
            {[
              ...
              { step: '03', title: "Lift Canada's Ranking", desc: "Every correct prediction earns points for Canada's global leaderboard position." },
              { step: '04', title: 'Build Your Legacy', desc: 'Be the top predictor from Canada. Your record lasts forever.' },
            ].map(({ step, title, desc }) => (
      ...
      <section style={{ padding: '64px 20px', backgroundColor: '#050E05', borderBottom: '1px solid #1A3A1A' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', marginBottom: '12px' }}>Top Canada Predictors</h2>
          <p style={{ color: '#6B7280', fontSize: '14px', marginBottom: '32px' }}>Who is the #1 football mind in Canada? Join now to claim your spot.</p>
      ...
      <section style={{ padding: '64px 20px', borderBottom: '1px solid #1A3A1A' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '28px', marginBottom: '12px' }}>Challenge your friends from Canada.</h2>
          <p style={{ color: '#9CA3AF', fontSize: '16px', marginBottom: '32px' }}>Go Canada! Share Flipseer with your football friends.</p>
          <a href="https://wa.me/?text=I%20am%20predicting%20every%20World%20Cup%202026%20match%20on%20Flipseer!%20Representing%20Canada%20-%20host%20nation%20on%20home%20soil!%20Join%20me%20https%3A%2F%2Fflipseer.com%2Fpredict%20Free.%20No%20betting.%20Pure%20football."
      ...
      <section style={{ padding: '80px 20px', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '36px', marginBottom: '16px', lineHeight: '1.3' }}>
            Go Canada. Make Canada Proud.<br /><span style={{ color: '#EF4444' }}>Start predicting now.</span>
          </h2>
