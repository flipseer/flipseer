    ...
    <main style={{ backgroundColor: '#0D1F0F', minHeight: '100vh', fontFamily: 'Arial, sans-serif', color: 'white' }}>
      ...
      <nav style={{ padding: '20px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #1A7A4A' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <a href="/leaderboard" style={{ backgroundColor: 'transparent', border: '1px solid #1A7A4A', color: '#2E9E5E', padding: '8px 16px', borderRadius: '8px', fontSize: '13px', textDecoration: 'none' }}>🏆 Leaderboard</a>
          <button onClick={handleSignOut} style={{ backgroundColor: 'transparent', border: '1px solid #1A7A4A', color: '#9CA3AF', padding: '8px 16px', borderRadius: '8px', cursor: 'pointer', fontSize: '13px' }}>Sign Out</button>
        </div>
      </nav>
      ...
      <section style={{ textAlign: 'center', padding: '60px 20px 40px' }}>
        ...
        {/* RANK BADGE */}
        <div style={{ display: 'inline-block', backgroundColor: '#0D2B14', border: '1px solid #1A7A4A', borderRadius: '999px', padding: '6px 20px', marginBottom: '32px' }}>
        ...
        {/* POINTS */}
        <div style={{ display: 'inline-block', backgroundColor: '#0D2B14', border: '2px solid #1A7A4A', borderRadius: '16px', padding: '24px 48px', marginBottom: '40px', marginLeft: '12px' }}>
