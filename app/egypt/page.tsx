...
export const metadata: Metadata = {
  title: 'Egypt Football Predictions | EPL & UCL | Flipseer',
  description: 'Egyptian football fans predict EPL, UCL and African football on Flipseer. Represent Egypt in the global Nation Battle. Free forever.',
...
export default function EgyptPage() {
  const steps = [
    ...
    { num: '3', title: 'Earn REP', desc: 'Correct predictions earn REP points for you and for Egypt in the Nation Battle.' },
  ]
  const competitions = [
    ...
    <main style={{ backgroundColor: '#0D1F0F', minHeight: '100vh', fontFamily: 'Arial, sans-serif', color: 'white', paddingBottom: '60px' }}>
      <div style={{ background: 'linear-gradient(180deg, #0D2B14 0%, #0D1F0F 100%)', padding: '48px 20px 32px', textAlign: 'center', borderBottom: '1px solid #1A3A1A' }}>
        ...
        <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(28px,6vw,44px)', marginBottom: '10px', fontWeight: 800 }}>
          Egypt Football Predictions
        </h1>
        <p style={{ color: '#9CA3AF', fontSize: '15px', maxWidth: '480px', margin: '0 auto 24px', lineHeight: 1.7 }}>
          Egypt is one of Africa&apos;s most decorated football nations. Egyptian forecasters on Flipseer predict EPL, UCL and international football — building a permanent Football Reputation and competing in the global Nation Battle.
        </p>
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/predict" style={{ backgroundColor: '#CE1126', color: 'white', padding: '12px 28px', borderRadius: '10px', textDecoration: 'none', fontSize: '14px', fontWeight: 700 }}>
            ⚽ Predict EPL matches for Egypt →
          </a>
